-- Fixed seed script matching actual database schema
-- Creates test users and tenant data
...
BEGIN
    ...
    -- Insert tenants (settings column exists, updated_at exists)
    ...
    -- Create tenant memberships (no updated_at column in this table)
    ...
    -- Create sample invitations (using inviter_user_id instead of invited_by, no accepted_at column)
